      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final double averageRating =
              service['averageRating'] ?? 0.0; // Fetch averageRating
          final int totalReviews =
              service['totalReviews'] ?? 0; // Fetch totalReviews
                    ...
                    Row(
                      children: [
                        ...
                        Icon(
                          averageRating >= 5
                              ? Icons.star
                              : Icons.star_half, // Full star or half star
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
              "Once you click 'Offer Now', ${widget.service['first name']} ${widget.service['last name']} will be able to see your offer. When they accept the offer, you'll be able to leave a review for each other."),
          actions: [
            TextButton(
