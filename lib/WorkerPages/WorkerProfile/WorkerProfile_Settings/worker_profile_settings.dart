...
import 'package:test_2/WorkerPages/WorkerProfile/WorkerProfile_Settings/worker_profile_notification.dart';
import 'package:test_2/WorkerPages/WorkerProfile/WorkerProfile_Settings/worker_profile_privacypolicy.dart';
import 'package:test_2/WorkerPages/WorkerProfile/WorkerProfile_Settings/worker_profile_security.dart';
...
import 'worker_profile_editprofile.dart'; 

class WorkerProfileSettings extends StatefulWidget {
  const WorkerProfileSettings({super.key});

  @override
  _WorkerProfileSettingsState createState() =>
      _WorkerProfileSettingsState();
}

class _WorkerProfileSettingsState extends State<WorkerProfileSettings> {
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: profileImageUrl != null
                              ? NetworkImage(
                                  profileImageUrl!) // Load image from Firebase Storage
    ...
    child: const CircleAvatar(
      ...
      child: Icon(Icons.edit, color: Colors.white),
                  ...
                  _buildSettingsOption(
                    ...
                    navigateTo: const WorkerProfileEditprofile(),
                  ),
                  _buildSettingsOption(
                    context,
                    'Notification',
                    Icons.notifications_none_outlined,
                    navigateTo: const WorkerProfileNotification(),
                  ),
                  _buildSettingsOption(
                    context,
                    'Security',
                    Icons.lock_outline,
                    navigateTo: const WorkerProfileSecurity(),
                  ),
                  _buildSettingsOption(
                    context,
                    'Privacy Policy',
                    Icons.privacy_tip_outlined,
                    navigateTo: const WorkerProfilePrivacypolicy(),
                  ),
                  _buildSettingsOption(
                    context,
                    'Terms and Conditions',
                    Icons.info_outline_rounded,
                    navigateTo: const WorkerProfileTerms(),
                  ),
